...
bottle_1_or_less = float(input("Enter the number of bottles of 1 liter or less  : "))
bottle_more_than_1 = float(input("Enter the number of bottles larger than one liter  : "))
payout = bottle_1_or_less * 0.10 + bottle_more_than_1 * 0.25
print(f"The payout is : ${payout:.2f}")
